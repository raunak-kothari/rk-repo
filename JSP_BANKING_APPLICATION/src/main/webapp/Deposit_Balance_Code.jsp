...
<body>
	...
	Double dep_amt = Double.parseDouble(request.getParameter("bal"));
	...
	try{
		...
		newbal = old_bal + dep_amt;
		
		PreparedStatement ps2 = con.prepareStatement("Update banking_cust_details set balance = ? where acc_no = ? ");
		...
		if (i == 1) {
			...
			out.print("<h1>" + "Before Depositing Account Balance : " + old_bal + "</h1>");
			out.print("<h1>" + " Deposit Account : " + dep_amt + "</h1>");
			out.print("<h1>" + "After Depositing Account Balance : " + newbal + "</h1>");
